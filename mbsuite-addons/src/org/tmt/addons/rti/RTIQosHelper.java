...
/**
 * Helper class for setting the QOS policies for datareaders, datawriters,
 * participant, factories, subscribers and publishers.
 * 
 */
public class RTIQosHelper {
	...
	private static Logger logger = Logger.getLogger(RTIQosHelper.class);

	/**
	 * Configures the QOS settings for DomainParticipantFactory
	 * 
	 * @param factory_qos
	 *            - the default qos
	 * @param factory
	 *            - the factory instance
	 * @param maxObjectsPerThread
	 *            - maximum number of objects per factory
	 */
	public static void configure_factory_qos(
			DomainParticipantFactoryQos factory_qos,
			DomainParticipantFactory factory, int maxObjectsPerThread) {
	...
	/**
	 * Configures the QOS settings for Transport for the DomainParticipant
	 * 
	 * @param locator
	 *            - the nic ip address over which data to be read/sent
	 * @param udpv4TransportProperty
	...
	/**
	 * Configures the QOS settings for the DataWriter
	 * 
	 * @param data_writer_qos
	 *            - default qos
	 * @param large_data
	 *            - flag for large data
	 * @param max_gather_send_buffers
	 *            - size of buffer
	 * @param publisher
	 *            - the publisher
	 * @param useMulticast
	 *            - flag for multicast
	 * @param isAsynch
	 *            - flag for asynch mode
	 * @param isReliable
	 *            - flag for reliable mode
	 * @param counter
	 *            - participant id
	 * @return
	 */
	public static int configure_data_writer_qos(DataWriterQos data_writer_qos,
			boolean large_data, int max_gather_send_buffers,
			Publisher publisher, boolean useMulticast, boolean isAsynch,
		...
		if (!isReliable) {
			...
			DataWriterQos_setReliableBursty(data_writer_qos, MAX_SAMPLES,
					getMaxBlockingTime());
			...
			if (large_data || isAsynch) {
				 ...
				 * single HB that gets appended when sending the last
				 * asynchronous sample in the queue, so it is ok to request one
				 * piggyback HB with every sample.
				 */
	...
	/**
	 * Maximum blocking time for reader/writer
	 * 
	 * @return
	 */
	...
	/**
	 * QOS settings for Reliable communication for DataWriter
	 * 
	 * @param qos
	 *            - default QOS
	 * @param worstBurstInSamples
	 *            - number of samples
	 * @param maxBlockingTime
	 *            - time to wait for sample
	 */
	 ...
	 * @param maxBlockingTime
	 *            - time to wait for sample
	 * @param alertReaderWithinThisMs
	 *            - time within which reader to be alerted
	 */
	private static void DataWriterQos_setReliableBursty(DataWriterQos qos,
			int worstBurstInSamples, Duration_t maxBlockingTime,
	...
	/**
	 * Used for multicast qos
	 * 
	 * @param qos
	 * @param readerQueueSize
	 */
	...
	/**
	 * Configures the QOS settings for the DataReader
	 * 
	...
	public static void configure_data_reader_qos(DataReaderQos data_reader_qos,
			Subscriber subscriber, boolean isReliable, int counter) {
...
//		data_reader_qos.reader_resource_limits.max_remote_writers = 1024;
	...
	/**
	 * Finds ports available for data read.
	 * 
	 * @return
	 */
	...
	/**
	 * QOS settings for Reliable communication for DataReader
	 * 
	 * @param qos
	 *            - default QOS
	 */
	 ...
	 * @param qos
	 *            - default QOS
	 * @param remoteWriterCountMax
	 *            - Maximum number of remote writers
	 */
	private static void DataReaderQos_setReliableBursty(DataReaderQos qos,
