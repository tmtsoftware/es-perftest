...
public class LatencyTestSubscriber extends SubscriberBase {
	...
	public void init(Map<String, String> attributes) {
		...
		data_topic = participant.create_topic("DataTopic", type_name,
				DomainParticipant.TOPIC_QOS_DEFAULT, null, // listener
				StatusKind.STATUS_MASK_NONE);
		echo_topic = participant.create_topic("EchoTopic", type_name,
				DomainParticipant.TOPIC_QOS_DEFAULT, null, // listener
				StatusKind.STATUS_MASK_NONE);
	...
	private class LatencyListener extends DataReaderAdapter {
		...
		/**
		 * Check if final ending message that signals the end of send and receive is
		 * received. 
		 */
