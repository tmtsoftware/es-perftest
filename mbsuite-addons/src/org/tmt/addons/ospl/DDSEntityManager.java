...
public class DDSEntityManager {
	...
	private DataReaderQos data_reader_qos = new DataReaderQos();
	...
	public void createParticipant(String partitionName) {
		...
		participant = dpf.create_participant(DDS.DOMAIN_ID_DEFAULT.value,
		...
		System.out.println("Created Domain participant ");
...
//		topicQos.value.resource_limits.max_samples_per_instance = 10000;
	...
	public void createWriter() {
		...
		WQosH.value.writer_data_lifecycle.autodispose_unregistered_instances = true;
	...
	public void createReader() {
		...
		reader = subscriber.create_datareader(topic,
				DATAREADER_QOS_USE_TOPIC_QOS.value, null,
				STATUS_MASK_NONE.value);
