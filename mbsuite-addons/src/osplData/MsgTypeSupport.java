...
{
    private static java.lang.String idl_type_name = "osplData::Msg";
    ...
    {
        super("osplData/MsgDataReaderImpl",
            "osplData/MsgDataReaderViewImpl",
            "osplData/MsgDataWriterImpl",
            "(LosplData/MsgTypeSupport;)V",
            "null",
            "null");
        ...
        try {
            success = org.opensplice.dds.dcps.FooTypeSupportImpl.Alloc(
                    ...
                    idl_type_name,
                    idl_key_list,
                    osplData.MsgMetaHolder.metaDescriptor);
