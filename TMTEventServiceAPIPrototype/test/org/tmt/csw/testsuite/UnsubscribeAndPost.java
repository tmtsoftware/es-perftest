...
/**
 * Unsubscribe a Callback for a consumer and Post Message--> The
...
public class UnsubscribeAndPost extends TestCase {
	 ...
	 */
	@Test
	public void testUnsubscribeAndPost() throws EventUnSubscriptionException,
			EventPublishException, EventSubscriptionException,
		...
		System.out.println("Consumer UNSubscribes to a Topic with one callback");
		...
		// Event received by callback is NULL - consumer unsubscribed with that callback
		assertNull(evt);
		System.out
