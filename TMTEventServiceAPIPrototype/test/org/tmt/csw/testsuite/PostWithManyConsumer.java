...
public class PostWithManyConsumer extends TestCase {
	...
	@Test
	public void testPostWithManyConsumer() {
		System.out
		...
		// ConsumerOne Subscribe to a Topic with a call back
		...
		// ConsumerTwo Subscribe to a Topic with call back -
		...
		assertNotNull(
				...
				evt);
		System.out.println("Event received by ConsumerOne Callback = [ " + evt
				+ "]");
