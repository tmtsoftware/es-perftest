...
public class SubscribeOneConsumerWithoutPost extends TestCase {
	...
	/**
	 * 8)  one consumer subscribe with a callback without publisher posting any message --> the
	 * consumer callback should not receive message
	 */
	...
	public void testSubscribeOneConsumerWithoutPost()
		...
		System.out.println("Event received by callback = ["
				+ evt + "]");
