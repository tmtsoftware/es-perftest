...
public class UnsubscribeAllConsumerWithoutPost extends TestCase {
	...
	/**
	 * 11) Consumer Unsubscribes from Topic with all callbacks whereas publisher had not posted any message--> The
	 * unregistered callbacks should receive the NULL
	 */
	@Test
	public void testUnsubscribeAllWithoutPost() throws EventPublishException,
			EventSubscriptionException, InterruptedException,
			EventUnSubscriptionException {

		System.out
				.println("******************* [11] [STARTING] UNSUBSCRIBE-ALL-WITHOUT-POST TEST ************************ ");
		// Create call-back
		...
		System.out.println("Consumer1 Subscribe to a Topic with two call backs");
		...
		System.out.println("Consumer2 Subscribe to a Topic with two call backs");
