...
/**
 * Post Message with multiple consumers and multiple callbacks --> Only one
 * callback of each consumer will receive message
 * 
 */
public class PostWithManyConsumerManyCallbck extends TestCase {
	...
	public void testPostWithManyConsumerManyCallbck() {
		...
		System.out
				.println("consumerOne Subscribes to a Topic with two call backs");
		try {
		...
		System.out
				.println("consumerTwo Subscribes to a Topic with two call backs -");
		try {
