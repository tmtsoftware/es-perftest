...
public class EventConsumerOne {
					...
					if (topic != null) {
						try {
							eventService.unSubscribe(topic,
									new EventCallbackImplOne());
							System.out
									.println("Call EventCallbackImplOne unsubscribed from topic:"
											+ topic);
	...
	public void unSubscribeAll(EventService eventService, String Topic) throws EventUnSubscriptionException {
		try {
			eventService.unSubscribeAll(Topic);
